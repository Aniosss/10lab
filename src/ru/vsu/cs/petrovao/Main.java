package ru.vsu.cs.petrovao;

import ru.vsu.cs.petrovao.classes.Faculty;
import ru.vsu.cs.petrovao.classes.Institute;
import ru.vsu.cs.petrovao.classes.ResearchAssociate;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ResearchAssociate emp1 = new ResearchAssociate(1234, "Митрофанова Елена Юрьевна",
        ...
        ResearchAssociate emp4 = new ResearchAssociate(1234, "Гаршина Вероника Викторовна",
